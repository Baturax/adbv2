...
print(
    "slect your phone's file transfer, set your phone to file transfer mode and enable usb debug mode in developer options.")
...
Button(root, text='Reboot Recovery', bg='#FFFFFF', font=('arial', 12, 'normal'), command=rebootrecovery).place(x=2,
                                                                                                               y=230)

Button(root, text='Reboot Bootloader', bg='#FFFFFF', font=('arial', 12, 'normal'), command=rebootbootloader).place(x=2,
                                                                                                                   y=265)
